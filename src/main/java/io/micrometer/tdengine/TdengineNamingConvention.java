 ...
 * @author Johnny Lim
 */
public class TdengineNamingConvention implements NamingConvention {
     ...
     */
    public TdengineNamingConvention() {
        this(NamingConvention.snakeCase);
    }

    public TdengineNamingConvention(NamingConvention delegate) {
